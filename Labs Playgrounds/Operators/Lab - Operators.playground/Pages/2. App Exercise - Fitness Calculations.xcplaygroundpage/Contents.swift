 ...
 */
let heartRate1 : Int = 65
let heartRate2 : Int = 78
let heartRate3 : Int = 94
...
let heartRate2D : Double = 78
let heartRate3D : Double = 94
let addedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRD / 3
print(averageHRD)
// Yes previous result was 79 and this was 79.0 it is beacuse the size of double differs from Integer
