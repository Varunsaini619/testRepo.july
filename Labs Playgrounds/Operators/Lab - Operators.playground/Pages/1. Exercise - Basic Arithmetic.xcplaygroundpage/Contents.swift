...
let roomArea = area / 2
print("Area of each room: \(roomArea)")
...
print("Perimeter of shed: \(perimeter)")
...
print("Integer division result of 10 / 3: \(integerDivisionResult)")
...
var circumfrence = 2*3.1415927*radius
print(diameter)
print(circumfrence)
...
print (even%2)
print (odd%2)
// if remainder  after dividing by 2 is 0 then it is even otherwise it will be odd number
