...
if let dayPresent = days["January"] {
    print("January has \(dayPresent) days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
let shapesArray = ["Oval", "Rectangle", "Square"]
let colorsArray = ["Blue", "Red", "Yellow"]
let artWork: [String: [String]] = ["Shapes": shapesArray, "Colors": colorsArray]
print(artWork)
...
if let colors = artWork["Colors"] {
    if let lastColor = colors.last {
        print("The last color is \(lastColor)")
    }
}
print("The last color is \(artWork["Colors"]!.last!)")
