 ...
 */
var walkingChallenges = ["Walk 2 times a day", "Walk without listening musoc"]
var runningChallenges = [ "Run on weekends", "Run for atleast 1hour"]
...
if commitedChallenges.isEmpty {
   ...
   print("The challenge you have chosen is <INSERT CHOSEN CHALLENGE>")
    ...
    print("You have chosen multiple chllaneges")
}
/*:
