...
// It says that Value of optional type 'Int?' must be unwrapped to a value of type 'Int'
...
print(userAge)
print("The value of userAge is nil beacusebthe string contains a typo and is not valid number, so it fails")
 ...
 */
print(userAge)
print("Yes it returns optional value as we used Int? and didnt unwrap")
print(userAge!)
