...
let returnedAge1 = checkAge(ageString: userInputAge)
print("Returned age:", returnedAge1)

let returnedAge2 = checkAge(ageString: "30")
...
func getItemCost(item: String) -> Double? {
    if let stockCount = stock[item], stockCount > 0 {
        return prices[item]
    }
    return nil
}
