...
let run = RunningWorkout(distance: 400, time: 20.0, elevation: 60)
print("Average mile time: \(run.averageMileTime) minutes")
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal {
                print("Congrats you achieved \(goal) steps")
            }
        }
    }
    var goal: Int
...
var mySteps = Steps(steps: 4500, goal: 10000)
