...
var varun = User(name: "Varun Saini", age: 19, height: 175.0, weight: 88, activityLevel: 7)
print("User Info:")
print("Name: \(varun.name)")
print("Age: \(varun.age)")
print("Activity Level: \(varun.activityLevel)/10")
print("Height: \(varun.height) cm")
print("Weight: \(varun.weight) kg")
...
print("1600 meters equals to \(mile.feet) feet.")

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
let sprint = Distance(feet: 529.084)
print("529.084 feet equals to \(sprint.meters) meters.")
