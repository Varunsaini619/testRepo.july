...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "Varun Saini", email: "varunsaini619.@gmailcom", age: 19)
}
...
let anotherUser = User(userName: "Varun ji", email: "varun@ji.com", age: 21)
User.logIn(user: anotherUser)

print("Updated Current User: \(User.currentUser.userName)")
