...
let rect = Rectangle(width: 15, height: 6)
...
struct Height {
    ...
    var heightInCentimeters: Double {
        didSet {
            let expectedIn = heightInCentimeters / 2.54
            if abs(heightInInches - expectedIn) > 0.001 {
                heightInInches = expectedIn
            }
        }
    }
...
print("Initially: \(myHeight.heightInInches) in \(myHeight.heightInCentimeters) cm")

myHeight.heightInInches = 90
print("After updating inches: \(myHeight.heightInInches) in \(myHeight.heightInCentimeters) cm")

myHeight.heightInCentimeters = 100
print("After updating cm: \(myHeight.heightInInches) in \(myHeight.heightInCentimeters) cm")
